...
sys.path.insert(0, os.path.abspath('/home/mrsud/workspace/BinPy/BinPy/combi_logic/'))
...
texinfo_documents = [
  ('index', 'BinPy', u'BinPy Documentation',
   u'BinPy', 'BinPy', 'One line description of project.',
   'Miscellaneous'),
]
